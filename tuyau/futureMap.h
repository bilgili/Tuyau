...
public:
     ...
     */
    TUYAU_API explicit FutureMap( const Futures& futures );
    TUYAU_API ~FutureMap();
     ...
     */
    TUYAU_API Futures getFutures( const std::string& name ) const;

    /**
     * @return the futures
     */
    TUYAU_API Futures getFutures() const;
     ...
     * given name
     */
    TUYAU_API bool isReady( const std::string& name ) const;
     ...
     * given name
     */
    TUYAU_API void wait( const std::string& name ) const;
     ...
     * given name
     */
    TUYAU_API void waitForAny( const std::string& name ) const;
     ...
     * given name
     */
    TUYAU_API void waitForAny() const;
...
public:
     ...
     */
    TUYAU_API explicit UniqueFutureMap( const Futures& futures );
    TUYAU_API ~UniqueFutureMap();
     ...
     * given name
     */
    TUYAU_API Future getFuture( const std::string& name ) const;
