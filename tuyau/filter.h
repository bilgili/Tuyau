...
public:
    ...
    /**
     * This function is called by the Executables while the filter is being executed.
     ...
     * data can be set.
     */
    TUYAU_API virtual DataInfos getInputDataInfos() const  { return DataInfos(); }
     ...
     */
    TUYAU_API virtual DataInfos getOutputDataInfos() const { return DataInfos(); }

    TUYAU_API virtual ~Filter() {}
};
