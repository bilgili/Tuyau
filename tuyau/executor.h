...
/**
 * Is base class for implementing different scheduling algorithms for Executable objects.
 * i.e. The IO or CPU intensive algorithms can implement their own scheduling algorithms.
 * The push/pull scheduling algorithms can also be implemented.
 */
class Executor
{
public:

    TUYAU_API virtual ~Executor() {}
