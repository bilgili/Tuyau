...
/**
 * Executable is the base class for execution. It provides methods for execution, preconditions and
 * postconditions for decision on scheduling.
 */
class Executable
{
public:
     ...
     */
    TUYAU_API Futures schedule( Executor& executor );
